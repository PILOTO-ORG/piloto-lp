...
const CTA: React.FC = () => {
  return (
    <section id="cta" className="py-20 px-4 md:px-8 lg:px-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            A revolução no atendimento imobiliário começa agora!
          </h2>
          <p className="text-lg opacity-90 max-w-3xl mx-auto mb-8">
            Entre em contato e veja como a Nanda pode transformar 
            o atendimento da sua imobiliária, aumentar suas vendas e economizar tempo.
          </p>
